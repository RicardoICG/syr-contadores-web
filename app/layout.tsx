        ...
        <nav className="bg-slate-950/80 backdrop-blur-md border-b border-slate-800 sticky top-0 z-50">
          <div className="max-w-6xl mx-auto px-4 py-3 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-0">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 md:gap-8 w-full md:w-auto">
              ...
              {/* NUEVO ENLACE: RECURSOS */}
              <Link href="/recursos" className="text-xs md:text-sm font-medium text-slate-300 hover:text-white transition-colors px-2 py-1">Recursos</Link>
            ...
            <div>
              ...
              <ul className="space-y-5">
                <li className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-slate-900 border border-slate-700 flex items-center justify-center text-blue-400 font-black shadow-inner">RC</div>
                  <div>
                ...
                <li className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-slate-900 border border-slate-700 flex items-center justify-center text-cyan-400 font-black shadow-inner">SP</div>
                  <div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                <li className="flex items-center gap-3">
                  ...
                  <a href="https://wa.me/51974684397" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors font-medium">+51 974 684 397</a>
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-lg">✉️</span>
                  <a href="mailto:Ricardoiscervantesg@gmail.com" className="hover:text-cyan-400 transition-colors break-all">Ricardoiscervantesg@gmail.com</a>
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-lg">✉️</span>
                  <a href="mailto:s5hyla14@gmail.com" className="hover:text-cyan-400 transition-colors break-all">s5hyla14@gmail.com</a>
                </li>
              </ul>
            </div>
          </div>
